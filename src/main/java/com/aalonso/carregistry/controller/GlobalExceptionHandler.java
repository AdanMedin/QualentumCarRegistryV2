...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleNullPointerException(NullPointerException e) {
        return new ResponseEntity<>(ERROR_OCCURRED + e.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<Object> handleOptimisticLockingFailureException(OptimisticLockingFailureException e) {
        return new ResponseEntity<>(ERROR_OCCURRED + e.getMessage(), HttpStatus.CONFLICT);
    }
    ...
    public ResponseEntity<Object> handleUnsupportedOperationException(UnsupportedOperationException e) {
        return new ResponseEntity<>(ERROR_OCCURRED + e.getMessage(), HttpStatus.NOT_IMPLEMENTED);
    }

    // Indica que el servidor no pudo encontrar el recurso solicitado.
    @ExceptionHandler(NoSuchElementException.class)
    public ResponseEntity<Object> handleNoSuchElementException(NoSuchElementException e) {
        return new ResponseEntity<>(ERROR_OCCURRED + e.getMessage(), HttpStatus.NOT_FOUND);
    }


    @ExceptionHandler(PersistenceException.class)
    public ResponseEntity<Object> handlePersistenceException(PersistenceException e) {
        return new ResponseEntity<>(ERROR_OCCURRED + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    // Indica que el usuario no se encuentra en la base de datos.
